...
namespace UI
{
    public partial class OptionPage
    {
        ...
        {
            var graphicsGroup = CreateOptionGroup("UI/OptionPage/GraphicsSettings");
            ...
            // 품질 이름들을 로컬라이징 키로 사용할 수 있도록 "UI/OptionPage/Quality_" 접두사를 붙여서 시도해볼 수 있음.
            // 하지만 일단은 기본 이름을 사용하고, 필요시 로컬라이징 처리를 하도록 함.
            qualityDropdown.Init(
                "UI/OptionPage/QualityLevel",
                qualityNames,
                currentQualityIndex,
                (index) =>
                {
