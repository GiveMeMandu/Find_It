namespace echo17.EndlessBook
{
    ...
    public class EndlessBook : MonoBehaviour
    {
        ...
        /// This is used in case the standin quality is changed wmaxhile the state is being changed.
        /// </summary>
        ...
        protected virtual GameObject LoadStandin(StateEnum state)
        {
            ...
            go.transform.localEulerAngles = new Vector3(0, 0f, 0);
            go.name = goName;
        ...
        protected virtual Page CreatePage()
        {
            ...
            page.transform.localEulerAngles = new Vector3(0, 0f, 0);
            page.name = "Page";
