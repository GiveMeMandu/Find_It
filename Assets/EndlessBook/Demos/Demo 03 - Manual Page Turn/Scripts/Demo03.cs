namespace echo17.EndlessBook.Demo03
{
	...
	public class Demo03 : MonoBehaviour
	{
		...
		protected virtual float GetNormalizedTime()
		{
			...
			var ray = sceneCamera.ScreenPointToRay(InputCompatibility.MousePosition());
			RaycastHit hit;
			...
			var viewportPoint = sceneCamera.ScreenToViewportPoint(InputCompatibility.MousePosition());
