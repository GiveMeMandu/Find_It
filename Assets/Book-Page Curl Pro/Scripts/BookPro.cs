    ...
    public class BookPro : MonoBehaviour
    {
        ...
        public void OnMouseDragRightPage()
        {
            if (interactable && !tweening)
            {
                ...
                DragRightPageToPoint(transformPointMousePosition(UnityEngine.InputSystem.Mouse.current.position.ReadValue()));
            }
        ...
        public void OnMouseDragLeftPage()
        {
            if (interactable && !tweening)
            {
                DragLeftPageToPoint(transformPointMousePosition(UnityEngine.InputSystem.Mouse.current.position.ReadValue()));
            }
        ...
        {
            f = Vector3.Lerp(f, transformPointMousePosition(UnityEngine.InputSystem.Mouse.current.position.ReadValue()), Time.deltaTime * 10);
